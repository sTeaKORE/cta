...
import tuwien.cta.external.CTGeneratorConnector
...
class TestDeclarationVisitor(
    ...
    private val generatorConnector = CTGeneratorConnector()
    ...
    override fun visitAnnotation(annotation: KSAnnotation, data: Unit) {
        ...
        for (argument: KSValueArgument in annotation.arguments) {
            ...
            if (argumentDeclaration is KSClassDeclaration) {
                ...
                generateACTSFile(inputModel)
                generatorConnector.generateTestSet()
            }
        }
    }

    private fun generateACTSFile(inputModel: CTAInputModel) {
        val filename = "${inputModel.systemName}ACTSConfig"
